...
import com.nova.bedshow.net.okhttp.builder.GetBuilder;
import com.nova.bedshow.net.okhttp.builder.PostFileBuilder;
import com.nova.bedshow.net.okhttp.builder.PostFormBuilder;
import com.nova.bedshow.net.okhttp.builder.PostStringBuilder;
import com.nova.bedshow.net.okhttp.callback.Callback;
import com.nova.bedshow.net.okhttp.https.HttpsUtils;
import com.nova.bedshow.net.okhttp.request.RequestCall;
